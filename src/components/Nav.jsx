      ...
      <ul className="flex items-center gap-8 list-none">
        ...
        <li>
          <a
            ...
            className="flex items-center gap-2 bg-gold text-offblack font-body font-bold text-[13px] tracking-[0.2em] uppercase px-5 py-2 hover:bg-gold-dark transition-colors duration-200"
          >
            <InstaIcon />
            Insta
          </a>
